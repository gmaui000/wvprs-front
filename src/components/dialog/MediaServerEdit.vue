        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form v-if="currentStep === 2 || currentStep === 3" ref="mediaServerForm1" :rules="rules" :model="mediaServerForm" label-width="140px" >
              ...
              <el-form-item label="流地址固定前缀" prop="ip">
                <el-input v-model="mediaServerForm.streamRoutePrefix" placeholder="流地址固定前缀(http/https)" clearable :disabled="mediaServerForm.defaultServer"></el-input>
              </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onSubmit: function () {
      ...
      let that = this;
      this.mediaServerForm.flvSSLPort = this.mediaServerForm.httpSSlPort;
      this.mediaServerForm.wsFlvSSLPort = this.mediaServerForm.httpSSlPort;
